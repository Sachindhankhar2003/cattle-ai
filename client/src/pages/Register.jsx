        ...
        >
          ...
          <div className="flex items-center space-x-6 pt-4">
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs uppercase tracking-widest text-slate-500 font-bold">Network</span>
            </div>
            <div className="h-8 w-px bg-white/10"></div>
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold text-white">Advanced</span>
              <span className="text-xs uppercase tracking-widest text-slate-500 font-bold">Tools</span>
            </div>
          </div>
        </motion.div>
      </div>
        ...
        >
          <div className="glass-morphism rounded-[2.5rem] p-10 border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-slate-400 font-medium">Join the BuffaloAI researcher community</p>
            </div>
            ...
            {error && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 rounded-2xl text-sm mb-6 text-center backdrop-blur-sm"
                >
                    {error}
                </motion.div>
            )}
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="btn-primary w-full py-4 rounded-2xl shadow-emerald-500/25 mt-6 group overflow-hidden relative"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/0 via-white/10 to-emerald-400/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
            ...
            <div className="mt-10 text-center lg:text-left">
              <p className="text-slate-400 text-sm font-medium">
                ...
                <Link to="/login" className="text-emerald-400 font-bold hover:text-emerald-300 transition-colors inline-flex items-center space-x-1 group">
                  <span>Sign In</span>
